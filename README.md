...
- 商品清单：按商品聚合展示价格，支持全部/名称/店铺范围搜索、店铺筛选、最低价标记、限时优惠标记；卡片上的价格、店铺和单价统一来自该商品的最新记录，最低价只作为标记展示。
- 商品详情：头部左侧显示紧凑商品图，右侧显示中文名和日文名；查看税后总价、规格、店铺、记录时间、各店现价排行、历史记录、税后价格走势。
...
- 个人主页：仅登录后显示入口，可查看自己的价格记录、商品、店铺和修改次数贡献统计。
