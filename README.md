...
- 生活工具：首页快捷入口可进入日本发快递测试；按尺寸、重量、匿名、追踪和补偿需求推荐寄送方式和估算运费。
...
- 商品记录：支持新增价格记录、修正记录、删除当前记录；修正时可补充/修改条形码、更换或删除图片；详情弹窗打开时锁定背景滚动。
...
- 日本发快递测试：http://localhost:3000/shipping.html
